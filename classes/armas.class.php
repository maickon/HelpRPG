<?php
//armas magicas, armas exoticas, armas comuns, armas simples
...
abstract class Armas{
	...
	function getDecisivo(){
		return $this->decisivo;
	}
	
	function setDecisivo($decisivo){
...
class ArmasSiples extends Armas{
	...
	protected $categoria = "Armas Simples";
	
	function __construct(){
		parent::__construct();
		$this->gerarTipoDeArma();
		$this->gerarNomeDaArma($this->getTipo());
		$this->gerarArmaSimples($this->getNome());
	}
	...
	function gerarArmaSimples($nome){
...
class ArmasComuns extends Armas{
	...
	private $categoria = "Armas Comuns";
	...
	function __construct(){
		...
		$this->gerarTipoDeArma();
		$this->gerarNomeDaArma($this->getTipo());
		$this->gerarArmaComun($this->getNome());
	}
...
class ArmasExoticas extends Armas{
	...
	function __construct(){
		...
		$this->gerarTipoDeArma();
		$this->gerarNomeDaArma($this->getTipo());
		$this->gerarArmaExotica($this->getNome());
	}
	...
	function gerarArmaExotica($nome){
		switch($nome){
...
class ArmasMagicas extends Armas{
	...
	function gerarArtefato($bonusMagico){
	...
	function gerarCustoDaArma($nome){
		switch($nome){
			case "Cimitarra":
