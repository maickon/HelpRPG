...
$descriacao= array('create'=>'Cadastrando um anuncio','edit'=>'Editando um anuncio','destroy'=>'Apagando um anuncio');
		 ...
		 $tag->elemento('form','class="userForm" method="post" action="" enctype="multipart/form-data" ');
			$tag->elemento('fieldset');
				...
				$tag->elemento('label','for="nome"');
					echo 'Nome:';
				$tag->close('label');
				$tag->elemento('input','type="text" size="50" name="nome" autofocus="autofocus" value="'.limpar_campo_excluir('nome',$objeto_resp).'"');
