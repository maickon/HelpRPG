...
$descriacao= array('create'=>'Cadastrando a página História','edit'=>'Editando a página História','destroy'=>'Apagando a página História');
		 ...
		 $tag->elemento('form','class="userForm custom" method="post" action="" enctype="multipart/form-data" ');
			$tag->elemento('fieldset');
				...
				$tag->elemento('label','for="titulo"');
					echo 'Título:';
				$tag->close('label');
				$tag->elemento('input','type="text" size="50" name="titulo" autofocus="autofocus" value="'.$objeto_resp->titulo.'"');
